...
---
### 💻 접근법
인사이트 : 리스트 슬라이싱을 사용하여 필요한 배열의 합을 반환

### 📝 슈도코드
```
def solution(정수 배열 num_list와 정수 n을 매개변수로 받는다):
    return num_list n에서 끝까지의 배열과 처음부터 n-1까지의 배열을 더한 값을 반환
```
```python
# 풀이 코드
